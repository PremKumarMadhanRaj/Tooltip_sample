  ...
  function (_super) {
    ...
    TreeView.prototype.updateCheckedStateFromDS = function (id) {
      if (this.treeData && this.showCheckBox) {
        ...
        } else if (this.dataType === 2 || this.fields.dataSource instanceof sf.data.DataManager && this.fields.dataSource.dataSource.offline) {
    ...
    TreeView.prototype.addChildData = function (obj, mapper, id, data, index) {
      ...
      for (var i = 0, objlen = obj.length; i < objlen; i++) {
        ...
        if (obj[i] && nodeId && nodeId.toString() === id) {
          if (typeof mapper.child === 'string' && obj[i].hasOwnProperty(mapper.child) || this.fields.dataSource instanceof sf.data.DataManager && obj[i].hasOwnProperty('child')) {
