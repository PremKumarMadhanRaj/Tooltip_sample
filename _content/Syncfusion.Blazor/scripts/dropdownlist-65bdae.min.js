(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dropdownlist"],{
    ...
    DropDownList.prototype.onActionComplete = function (ulElement, list, e, isUpdated) {
      ...
      if (this.isActive) {
        ...
        if (this.getModuleName() !== 'autocomplete' && this.isFiltering() && !this.isTyped) {
          if (!this.actionCompleteData.isUpdated || !this.isCustomFilter && !this.isFilterFocus && (this.dataSource instanceof sf.data.DataManager || !sf.base.isNullOrUndefined(this.dataSource) && !sf.base.isNullOrUndefined(this.dataSource.length) && this.dataSource.length !== 0)) {
            this.actionCompleteData = {
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.dropdownlist, function () {
