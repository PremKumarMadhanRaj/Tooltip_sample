(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bulletchart"],{
...
var sfbulletchart = function sfbulletchart(exports) {
  ...
  function () {
    ...
    BaseLegend.prototype.renderPagingElements = function (chart, bounds, textOption, legendGroup) {
      ...
      var pageTextElement = textElement$1(chart.renderer, textOption, legend.textStyle, legend.textStyle.color, paginggroup, false, false, false, false, null, new sf.svgbase.Rect(bounds.width - (2 * (iconSize + padding) + padding + size.width), 0, 0, 0)); // Page right arrow rendering calculation started here
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.bulletchart, function () {
