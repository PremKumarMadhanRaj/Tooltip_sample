...
var sfdashboardlayout = function sfdashboardlayout(exports) {
  ...
  function (_super) {
    ...
    DashboardLayout.prototype.calculateCellSize = function () {
      ...
      if (this.checkMediaQuery()) {
        this.cellSize[1] = this.element.parentElement && Math.floor(this.element.parentElement.offsetWidth) / this.cellAspectRatio;
      } else {
        this.cellSize[0] = this.element.parentElement && Math.floor(this.element.parentElement.offsetWidth);
        this.cellSize[0] = this.element.parentElement && Math.floor((this.element.parentElement.offsetWidth - (this.maxCol() - 1) * this.cellSpacing[0]) / this.maxCol());
    ...
    DashboardLayout.prototype.setHeightWidth = function () {
      ...
      if (this.checkMediaQuery()) {
        heightValue = this.maxRow() * (this.element.parentElement && Math.floor(this.element.parentElement.offsetWidth) / this.cellAspectRatio) + (this.maxRow() - 1) * this.cellSpacing[1] + 'px';
      } else {
