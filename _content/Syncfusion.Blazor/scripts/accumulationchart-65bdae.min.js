...
var sfaccumulationchart = function sfaccumulationchart(exports) {
  ...
  function createTemplate(childElement, pointIndex, content, chart, point, series, dataLabelId) {
    ...
    try {
      ...
      var elementData = templateFn ? templateFn(tempObject, null, null, dataLabelId || childElement.id.replace(/[^a-zA-Z0-9]/g, '')) : [];
  ...
  function () {
    ...
    BaseLegend.prototype.renderPagingElements = function (chart, bounds, textOption, legendGroup) {
      ...
      var pageTextElement = textElement(chart.renderer, textOption, legend.textStyle, legend.textStyle.color, paginggroup, false, false, false, false, null, new sf.svgbase.Rect(bounds.width - (2 * (iconSize + padding) + padding + size.width), 0, 0, 0)); // Page right arrow rendering calculation started here
    ...
    AccumulationDataLabel.prototype.drawDataLabels = function (series, dataLabel, parent, templateElement, redraw) {
      ...
      for (var _i = 0, modifiedPoints_1 = modifiedPoints; _i < modifiedPoints_1.length; _i++) {
        ...
        if (!sf.base.isNullOrUndefined(point.argsData) && !sf.base.isNullOrUndefined(point.y)) {
          ...
          var location_3 = void 0; // tslint:disable-next-line:max-line-length

          var childElement = sf.base.createElement('div', {
            id: this.accumulation.element.id + '_Series_' + 0 + '_DataLabel_' + point.index,
            styles: 'position: absolute;background-color:' + point.argsData.color + ';' + // tslint:disable-next-line:max-line-length
            getFontStyle(dataLabel.font) + ';border:' + point.argsData.border.width + 'px solid ' + point.argsData.border.color + ';'
          });
          var textSize = point.argsData ? this.getTemplateSize(childElement, point, point.argsData, redraw) : sf.svgbase.measureText(point.label, dataLabel.font);
          var element = void 0;
        ...
        for (var _i = 0, _a = chart.axisCollections; _i < _a.length; _i++) {
          ...
          if (xAxisName === axis.name || xAxisName == null && axis.name === 'primaryXAxis') {
            ...
            if (xAxis.valueType.indexOf('Category') > -1) {
              ...
              xValue = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.annotation.x) === 'object' ? Date.parse(chart.intl.getDateParser(option)(chart.intl.getDateFormat(option)(new Date(sf.data.DataUtil.parse.parseJson({
                val: annotation.x
              }).val)))) : 0;
            } else {
              xValue = +annotation.x;
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.accumulationchart, function () {
