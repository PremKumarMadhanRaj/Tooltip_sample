(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["documenteditorbase"],{

/***/ "./bundles/documenteditorbase.js":
/*!***************************************!*\
  !*** ./bundles/documenteditorbase.js ***!
  \***************************************/
/*! no exports provided */
...
/* harmony import */ var _modules_documenteditorbase_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/documenteditorbase.js */ "./modules/documenteditorbase.js");
/* harmony import */ var _modules_documenteditorbase_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_documenteditorbase_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./modules/documenteditorbase.js":
/*!***************************************!*\
  !*** ./modules/documenteditorbase.js ***!
  \***************************************/
...
var documenteditorbase = function (exports) {
  'use strict';
  /**
   * @private
   */
  ...
  function () {
    ...
    XmlHttpRequestHandler.prototype.stateChange = function (proxyReq) {
      ...
      } else if (proxyReq.xmlHttpRequest.readyState === 4 && proxyReq.xmlHttpRequest.status === 400) {
        // jshint ignore:line)
        // tslint:disable-next-line
        var result = {
          name: 'onFailure',
...
sfBlazor.modules["documenteditorbase"] = "documenteditor.DocumentEditor";
window.sf.documenteditor = window.sf.base.extend({}, window.sf.documenteditor, documenteditorbase({}));
