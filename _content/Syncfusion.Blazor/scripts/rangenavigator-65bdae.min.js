(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["rangenavigator"],{
...
var sfrangenavigator = function sfrangenavigator(exports) {
  ...
  function (_super) {
    ...
    DateTime.prototype.getActualRange = function (axis, size) {
      ...
      if (axis.minimum !== null) {
        this.min = Date.parse(dateParser(dateFormatter(new Date(sf.data.DataUtil.parse.parseJson({
          val: axis.minimum
        }).val))));
      } else if (this.min === null || this.min === Number.POSITIVE_INFINITY) {
      ...
      if (axis.maximum !== null) {
        this.max = Date.parse(dateParser(dateFormatter(new Date(sf.data.DataUtil.parse.parseJson({
          val: axis.maximum
        }).val))));
      } else if (this.max === null || this.max === Number.NEGATIVE_INFINITY) {
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.rangenavigator, function () {
